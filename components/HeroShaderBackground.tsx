...
function LightBallpitBackground() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-background" aria-hidden="true">
      ...
      {canRenderBallpit ? (
        <div className="absolute inset-0 h-full w-full opacity-90 pointer-events-auto">
          <Ballpit
            count={130}
            gravity={0}
            friction={0.967}
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_76%_24%,transparent_0%,transparent_36%,var(--background)_76%),linear-gradient(90deg,var(--background)_0%,rgba(252,255,253,0.70)_40%,transparent_82%)] pointer-events-none" />
...
function DarkTerminalBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_30%,transparent_0%,var(--background)_70%),linear-gradient(90deg,var(--background)_0%,transparent_55%,var(--background)_100%)] opacity-85 pointer-events-none" />
      <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-b from-transparent to-background pointer-events-none" />
    </div>
  );
}

function ClientOnlyBackground({ theme }: { theme: string }) {
  ...
  if (theme === "light") {
    return <LightBallpitBackground />;
  }
  return <DarkTerminalBackground />;
}
...
export function HeroShaderBackground() {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none" aria-hidden="true">
      <LightFallbackBackground />
      <ClientOnlyBackground theme={resolvedTheme} />
    </div>
  );
}
