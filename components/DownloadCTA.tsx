...
export function DownloadCTA() {
  return (
    <div className="relative flex flex-col items-center gap-4 sm:flex-row">
      <CosmicButton
        href={PLAY_STORE_URL}
        icon={<img src="https://cdn.prod.website-files.com/67e36aa2068f30979d6c5e1f/68ba60758094c8a92ad7566e_7db42ca6494f3a8a8f88cb1bbc4e9d3c_android.svg" alt="Android" className="size-[18px] object-contain" />}
        external
      >
      ...
      <CosmicButton
        ...
        variant="secondary"
        icon={<img src="https://cdn.prod.website-files.com/67e36aa2068f30979d6c5e1f/68ba6075b6f5660be18bbbdf_f37bfbd98fdd5d913fc34a92c43dc6ec_apple.svg" alt="Apple" className="size-[17px] object-contain" />}
        external
        badge={
