...
export function DownloadCTA() {
  ...
  return (
    <div className="relative flex flex-col sm:flex-row items-center gap-4">
        ...
        <AnimatePresence>
          {showQR && (
            <motion.div
              ...
              className="absolute z-10 bottom-14 left-1/2 -translate-x-1/2 p-4 bg-surface-1 border border-white/10 rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.6)] flex flex-col items-center gap-2 min-w-[200px]"
            >
      ...
      <a
        href="#ios-waitlist"
        className="h-12 px-6 flex items-center gap-2 rounded-full bg-transparent text-text-primary font-semibold text-sm tracking-tight border border-white/10 hover:bg-surface-2 hover:border-white/20 active:scale-98 transition-all duration-300 select-none group"
      >
        iOS coming soon
        <span className="text-[10px] font-medium text-text-quiet tracking-tight px-1.5 py-0.5 rounded bg-white/5 group-hover:bg-white/10 transition-colors">
          Waitlist
        </span>
      </a>
    </div>
